...
contract LendingPoolFactoryTest is Test {
    ...
    function test_CreatePool_RegistersPoolByName() public {
        ...
        address poolAddress = factory.createPool(
            7500, 8000, 200, 400, 6000, 8500, 500, 1000,
            lending,
            yieldContract,
            "ETH-Pool"
        );
    ...
    function test_CreatePool_CreatesMultiplePools() public {
        ...
        address pool2 = factory.createPool(
            8000, 8500, 300, 500, 7000, 9000, 600, 1500,
            lending,
            yieldContract,
            "Pool2"
        );
    ...
    function test_Integration_CreateAndRetrieveMultiplePools() public {
        ...
        address usdc = factory.createPool(
            7500, 8000, 200, 400, 6000, 8500, 500, 1000,
            lending, yieldContract, "USDC"
        );
        
        address eth = factory.createPool(
            7000, 7500, 300, 500, 7000, 8000, 600, 1200,
            lending, yieldContract, "ETH"
        );
        
        address btc = factory.createPool(
            6500, 7000, 400, 600, 8000, 7500, 700, 1400,
            lending, yieldContract, "BTC"
        );

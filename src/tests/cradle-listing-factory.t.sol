...
contract CradleListingFactoryTest is Test {
    ...
    function test_CreateListing_CreatesListingSuccessfully() public {
        address listingAddress = factory.createListing(
            feeCollector,
            reserve,
            1000000,
            asset,
    ...
    function test_CreateListing_CreatesMultipleListings() public {
        address listing1 = factory.createListing(
            feeCollector,
            reserve,
            1000000,
            asset,
        ...
        address listing2 = factory.createListing(
            feeCollector,
            reserve,
            2000000,
            asset,
    ...
    function test_CreateListing_WithDifferentParameters() public {
        address listing = factory.createListing(
            feeCollector,
            reserve,
            5000000,
            asset,
